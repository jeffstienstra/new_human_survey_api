...
user1.favorites.create(category: "person", description: "Kate - daughter")
user1.favorites.create(category: "person", description: "Olivia - daughter")
user1.favorites.create(category: "person", description: "Eli - son")
user1.favorites.create(category: "person", description: "Ruby - daughter")
user1.favorites.create(category: "person", description: "Patrick - foster son")
user1.favorites.create(category: "person", description: "Sandra - foster daughter")
user1.favorites.create(category: "person", description: "Wanda - foster daughter")
user1.favorites.create(category: "person", description: "Roxana - foster daughter")
user1.favorites.create(category: "person", description: "Sara - foster (grand?)daughter")
user1.favorites.create(category: "person", description: "Amal - foster (grand?)daughter")
user1.favorites.create(category: "person", description: "Sadie Mae - Cocker Spaniel/Golden Retriever")
user1.favorites.create(category: "person", description: "Cuddles - cat")
